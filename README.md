...
- **Launch Platform / Launch module**: links out to the live product demo at `https://payreality.aisecurewatch.com`. That demo is a separate deployment (not this repo, still hosted on Vercel, just under this domain now instead of the `.vercel.app` default); its module cards link to the demo's home page rather than deep-linking to a specific module.
