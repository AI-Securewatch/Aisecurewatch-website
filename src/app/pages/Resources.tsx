...
const PLACEHOLDER_CATEGORIES = [
  ...
  { icon: Building2, title: "Case Studies", desc: "How enterprise teams put delegated authority infrastructure into production." },
  ...
  return (
    <>
      <SEO
        ...
        description="Research, articles, and technical writing on Enterprise AI Authority Infrastructure, delegated authority, and deterministic AI execution, from AI Securewatch."
        path="/resources"
        jsonLd={{
      ...
      <main className="pt-40 pb-32 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed mb-16" style={{ fontSize: "1.125rem", maxWidth: 640 }}>
            Research and technical writing on Enterprise AI Authority Infrastructure, delegated
            authority, and runtime enforcement — from the team building it.
          </p>
