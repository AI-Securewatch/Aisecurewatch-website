...
const TERMS = [
  { term: "Authority", def: "The right, held by an organization, to take a specific action or to delegate that right to someone, or something, else. Organizations already have authority, built for people; PayReality doesn't invent a new authority model for AI, it operationalizes the one that already exists." },
  ...
  { term: "Reasoning vs. Authority", def: "An AI agent can reason, analyze, recommend, negotiate, and plan. Authority to actually act has to come from the organization, not from the AI itself, no matter how well it reasoned its way there. Runtime Authority is how that organizational authority gets enforced at the moment the agent tries to act." },
  { term: "Runtime Authority", def: "The infrastructure layer that enforces, immediately before execution, whether an autonomous AI agent's action falls within the authority the organization has already delegated. The flagship product inside Enterprise AI Authority Infrastructure, the broader category it belongs to.", href: "/products/runtime-authority" },
  { term: "AI Workforce Arc", def: "The progression from AI assisting people, to AI executing tasks under supervision, to AI operating as a standing part of the workforce, taking real actions inside enterprise systems on its own. Runtime Authority exists because organizational authority has to hold across all three stages, especially the third." },
